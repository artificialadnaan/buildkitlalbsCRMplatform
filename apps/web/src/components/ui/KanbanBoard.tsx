    ...
    <div className="flex gap-4 overflow-x-auto pb-4">
      {sortedStages.map((stage) => {
        ...
        return (
          <div
            key={stage.id}
            className="flex w-72 shrink-0 flex-col rounded-lg border border-border bg-gray-100"
          >
            <div className="flex items-center gap-2 border-b border-border px-4 py-3">
              ...
              />
              <span className="text-xs font-semibold uppercase tracking-wider text-gray-700">{stage.name}</span>
