    ...
    <div className="space-y-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <button onClick={addLineItem} className="text-xs text-brand-600 hover:text-brand-700">+ Add Item</button>
        </div>
      ...
      <div className="flex justify-between items-center pt-2 border-t border-border">
        ...
        <button
          ...
          className="bg-brand-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-brand-600 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {submitLabel}
        </button>
      </div>
